...
export interface AuthUser { isSignedIn: boolean; isSubscribed: boolean; isAdmin: boolean; email: string | null; name: string | null; birthdate: string | null; authMode: "whop" | "demo"; }
...
const DEFAULT_STATE: AuthState = {
  user: { isSignedIn: false, isSubscribed: false, isAdmin: false, email: null, name: null, birthdate: null, authMode: "demo" },
